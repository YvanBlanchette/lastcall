...
export default function AidePage() {
  return (
    <div className="mx-auto max-w-2xl px-6 py-8">
      <PageHeader title="Aide" description="Les questions qui reviennent le plus souvent." />

      <Card className="mt-6 p-5">
        <h2 className="font-semibold text-navy-900">Modèle d'import</h2>
        <p className="mt-1 text-sm text-navy-500">
          Le fichier Excel officiel, avec les bonnes colonnes et une ligne d'exemple.
        </p>
        <Link
        ...
        >
          <Download className="h-4 w-4" aria-hidden /> Télécharger le modèle
        </Link>
      </Card>
